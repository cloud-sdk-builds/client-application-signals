...
[`@aws-sdk/client-application-signals`](https://www.npmjs.com/package/@aws-sdk/client-application-signals/v/3.1097.0).
...
- @aws-sdk/client-application-signals v3.1097.0 - [https://cloud-sdk-builds.github.io/?sdk=client-application-signals&version=3.1097.0](https://cloud-sdk-builds.github.io/?sdk=client-application-signals&version=3.1097.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-signals@3.1097.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d+jErrDsYYGzeX7/Uw4VGKnrgC1v60fb8DZJwZXGisI38B9X41+Y3w03TSe4xWDr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-application-signals": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-signals@3.1097.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-signals@3.1097.0/index.min.mjs": "sha384-d+jErrDsYYGzeX7/Uw4VGKnrgC1v60fb8DZJwZXGisI38B9X41+Y3w03TSe4xWDr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-application-signals/blob/refs/tags/3.1097.0/LICENSE
```
